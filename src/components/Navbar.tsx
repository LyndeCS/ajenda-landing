...
import ajendaIcon from "../assets/AjendaLogo_Padded.png";
		...
		<nav className="absolute w-full z-50 bg-white bg-opacity-70 py-4 shadow-sm">
			<div className="mx-auto max-w-7xl px-4 flex justify-between items-center">
				...
				<div className="flex items-center">
					...
					/>
					<a href="#" className="text-3xl font-medium text-[#00BE92]">
						jenda
					</a>
				</div>
				...
				<div className="hidden md:flex items-center space-x-8">
					<a
						...
						className="text-black font-medium hover:text-mint"
					>
						Product
					</a>
					<a
					...
					<a
						...
						className="bg-gradient-to-br from-aqua via-mint to-mintlighter text-white font-medium px-4 py-2 border-[1px] border-mint hover:bg-gradient-to-br hover:from-mint hover:via-mintdarker hover:to-mintlighter hover:shadow rounded-lg"
					>
						Try Ajenda
					</a>
				</div>
				...
				{isMenuOpen && (
					<div className="absolute z-10 top-12 right-0 bg-white bg-opacity-100 p-2 shadow-md text-center">
						<a
							href="#product-section"
							className="block text-black font-medium hover:text-mint mb-2"
						>
							Product
						</a>
						<a
